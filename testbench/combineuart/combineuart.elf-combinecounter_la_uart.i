# 0 "combinecounter_la_uart.c"
# 1 "/home/ubuntu/lab6/lab-wlos_baseline/testbench/combineuart//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "combinecounter_la_uart.c"
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
...
# 2 "combinecounter_la_uart.c" 2
# 1 "../../firmware/user_uart.h" 1
# 3 "combinecounter_la_uart.c" 2
# 1 "../../firmware/stub.c" 1
# 18 "../../firmware/stub.c"
void putchar(char c)
{
...
extern int* matmul();
extern int* qsort();
# 29 "combinecounter_la_uart.c"
void main()
{

    int mask;
# 58 "combinecounter_la_uart.c"
 int j;
 ...
 int* tmp_fir = fir();
 (*(volatile uint32_t*)0x2600000c) = *tmp_fir << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_fir+6) << 16;
 ...
 (*(volatile uint32_t*)0x2600000c) = *(tmp_MM+9) << 16;
 for(int i=0;i<k;i++);
...
# 255 "combinecounter_la_uart.c"
 ...
 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+2) << 16;
 for(int i=0;i<k;i++);


 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+3) << 16;
 for(int i=0;i<k;i++);


 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+4) << 16;
 for(int i=0;i<k;i++);


 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+5) << 16;
 for(int i=0;i<k;i++);


 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+6) << 16;
 for(int i=0;i<k;i++);


 (*(volatile uint32_t*)0x2600000c) = *(tmp_qs+7) << 16;
 for(int i=0;i<k;i++);
